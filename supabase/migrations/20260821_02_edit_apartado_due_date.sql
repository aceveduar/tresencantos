-- -----------------------------------------------------------------------------
-- edit_apartado_atomic gana p_due_date -- permite ver y ajustar la fecha
-- limite de pago al editar un apartado (agregar/quitar productos), sin
-- recalcularla sola. Antes el campo no se enviaba nunca desde el cliente y
-- la fecha original quedaba intacta sin que nadie la viera al editar, sin
-- importar cuanto creciera el total. NULL (default) preserva la fecha
-- actual -- editar sin tocar la fecha nunca la borra por accidente.
-- -----------------------------------------------------------------------------
