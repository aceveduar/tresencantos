...
function openForm(id) {
  ...
  if (id) {
    ...
    document.getElementById('f-supplier-code').value = p.supplierCode || '';
    updateMarginDisplay();
...
function _updateActiveFiltersBar() {
  ...
  const _facIco = p => `<svg width="13" height="13" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px;margin-right:3px">${p}</svg>`;
...
function validateForm() {
  ...
  const markError = (inputId, msg) => {
    ...
    err.innerHTML = '<svg width="12" height="12" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-1px;margin-right:3px"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>' + msg;
...
async function saveProduct() {
  ...
  const data = {
    ...
    supplierCode: document.getElementById('f-supplier-code').value.trim() || null,
